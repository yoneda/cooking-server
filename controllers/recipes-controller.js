...
// MEMO: 以下のSQL文と同等
/*
SELECT r.*, u.account, GROUP_CONCAT(DISTINCT(d.text) SEPARATOR ",") AS directions, GROUP_CONCAT(DISTINCT(b_r_i.name) SEPARATOR ",") AS ingredients
FROM recipes AS r
...
// TODO: group_concat(distinct(…))のあたりの文法が怪しい。SQLの勉強し直す
